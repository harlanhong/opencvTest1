...
//using namespace std;
//using namespace cv;
//string imgTrain2 = "imgTrain2";
//string imgTrain = "imgTrain";
//string filePath = "config";
//string specialTrain = "specialTrain";
//
...
//		cout << "i:" << i << endl;
//	}
//	for (int i = 0; i < sercondFile; ++i) {
//		vector<float> descriptors;
//		image = imread(imgTrain2 + "\\" + to_string(i) + ".jpg", 1);
//		Size sz(64, 64);
//
//		resize(image, image, sz);
//		cvtColor(image, image, CV_BGR2GRAY);
...
//			//imwrite(specialTrain+"\\"+to_string(k)+".jpg", finalyImg);
//			k++;
...
//	is_thresh = false;
//	//单目标定
//	//singleCameraCalibrate(0, "R-17.6.9-3");
//	//waitKey(0);
//	//destroyAllWindows();
//	//=====================================
//	//R-17.5.17-2,
//	//现在是R7，L7最好
//	//双目标定
//	//TwoCameraCalibrate(2,"L-17.6.9-3",0,"R-17.6.9-3","in-17.6.16-1","ex-17.6.16-1");
//	//waitKey(0);
//	//destroyAllWindows();
//	//测试
...
//	//waitKey(0);
//	//destroyAllWindows();
//	twoTest("in-17.6.16-1","ex-17.6.16-1",2,0);
//	waitKey(0);
//	destroyAllWindows();
//	
//	//手势识别
//	//gestureDetection("in-17.6.9-3", "ex-17.6.9-3", 2, 1);
